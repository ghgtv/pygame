...
from entities.constants import WIDTH, HEIGHT, FPS, SHOOT_DELAY
...
from entities.refill import BulletRefill, HealthRefill, DoubleRefill, ExtraScore
from entities.meteors import Meteors, Meteors2
from entities.explosions import Explosion, Explosion2
from entities.enemies import Enemy1, Enemy2
from entities.bosses import Boss1, Boss2, Boss3
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if bullet_counter > 0 and pygame.time.get_ticks() - last_shot_time > SHOOT_DELAY:
                ...
                bullets.add(bullet)
                bullet_counter -= 1
                # bullet.shoot(surface)
            is_shooting = True

        elif event.type == pygame.MOUSEBUTTONUP and event.button == 1 and player.original_image is not None:
